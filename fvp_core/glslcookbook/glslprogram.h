...
class GLSLProgram {
 ...
 public:
  ...
  void setUniform(const std::string name, const std::vector<glm::mat4> &m,
                  const int array_num);
  void setUniform(const char *name, const glm::mat3 &m);
  void setUniform(const char *name, double val);
  void setUniform(const std::string name, double val);
  void setUniform(const char *name, double *val, const int array_num);
  void setUniform(const std::string name, double *val, const int array_num);
  void setUniform(const char *name, float val);
  void setUniform(const char *name, float *val, const int array_num);
