...
// singleton GLModelManager CLASS
class GLModelManager {
private:
	GLModelManager()
	{
		std::cout << "initialize GLModelManager : " << std::endl;
	};					
	~GLModelManager() = default;
public:
	GLModelManager(const GLModelManager&) = delete;
	GLModelManager& operator=(const GLModelManager&) = delete;
	GLModelManager(GLModelManager&&) = delete;
	GLModelManager& operator=(GLModelManager&&) = delete;

	static GLModelManager& getInstance() {
		static GLModelManager inst;
		return inst;
	}
