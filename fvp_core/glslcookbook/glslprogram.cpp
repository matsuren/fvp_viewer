...
void GLSLProgram::setUniform(const std::string name, const std::vector<mat4> & m, const int array_num)
{
...
void GLSLProgram::setUniform(const char *name, float *val, const int array_num)
{
	GLint loc = getUniformLocation(name);
...
void GLSLProgram::setUniform(const std::string name, double *val, const int array_num)
{
	setUniform(name.c_str(), val, array_num);
}

void GLSLProgram::setUniform(const char *name, double *val, const int array_num)
{
	GLint loc = getUniformLocation(name);
